...
import { POLYGON, BITCOIN, POLYGON_TESTNET_CODE, POLYGON_STORAGE_KEY, BITCOIN_STORAGE_KEY, CRYPTO_API_KEY } from '../constants/commonConstants';
...
export const importPolygonWallet = async (walletStore, privateKey) => {
    if (isPolygonPrivateKeyValid(privateKey)) {
        try {
            const ALCHEMY_API_KEY = process.env.EXPO_PUBLIC_ALCHEMY_KEY;
